	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				<a href="#" class="navbar-brand">BEKKALI Store</a>
			</div>
								...
								while ($row=mysqli_fetch_array($query)) {
									?>
										<div class="row">
											...
											<div class="col-md-6">
												<table>
													<tr><td>Nom de produit</td><td><b><?php echo $row["product_title"]; ?></b> </td></tr>
													<tr><td>Prix de produit</td><td><b><?php echo "dhs ".$row["product_price"]; ?></b></td></tr>
													<tr><td>Quantite</td><td><b><?php echo $row["qty"]; ?></b></td></tr>
