			...
			echo "
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading'>dhs.$pro_price.00
			...
			while ($row=mysqli_fetch_array($query)) {
				...
				echo '
					<div class="row">
						...
						<div class="col-md-3">dhs'.$product_price.'</div>
					</div>';
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="elachhab96@outlook.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/ElachhabStore/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/ElachhabStore/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/ElachhabStore/cancel.php"/>
